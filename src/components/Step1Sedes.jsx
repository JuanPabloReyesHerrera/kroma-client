      ...
      <div className="grid grid-cols-2 gap-5 place-items-center">
        {sedes.map((sede) => (
          ...
          <button
            ...
            className="w-full p-4 py-10 border border-slate-200 rounded-xl hover:border-indigo-500 hover:bg-indigo-50 transition-all text-left flex justify-between items-center group bg-white"
          >
            <div>
